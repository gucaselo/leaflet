...
d3.json(queryUrl).then(function(data){
    ...
    var usgsSat = L.tileLayer.provider('USGS.USImageryTopo');
    var usgsLight = L.tileLayer.provider('USGS.USTopo');
    ...
    var myMap = L.map("map", {
        ...
        zoom: 5,
        layers: [usgsSat, earthquake, tectonicMarkers]
        });
